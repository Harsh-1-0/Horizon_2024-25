...
function Home() {
  return (
    <div>
      <div className="hidden lg:block w-full text-[#1E1E1E]  bg-[#b5ddc2]">
        ...
        <div className="flex  w-full bg-[#b5ddc2] items-center h-2/3 border-t-black border-b-black border-2 ">
          <div className="w-2/3 h-full   p-12 block text-5xl font-poppins">
            
            
            <span className=" text-5xl font-poppins ">One of the Biggest Technical</span>
            <span className="block text-5xl  font-poppins pt-8">
              Fests in India
              <span className="font-extrabold "> is back in 2024</span>
            </span>
            <br />
            <span className="block text-3xl pb-[6vh] font-poppins ">
              See you at Horizon!
            </span>
            <br />
            <button
              type="submit"
              className="bg-[#F2C6AB] px-6 py-4 border-black border-2 rounded-full text-2xl font-normal"
            >
              Register Now
            </button>
          </div>
          <div className="w-1/3 h-full flex items-center justify-center relative overflow-hidden p-8 border-black border-l-2">
