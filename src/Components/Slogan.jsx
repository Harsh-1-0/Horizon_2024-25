...
const Slogan = ({ children }) => {
  return (
    ...
    <div className="custom:hidden flex max-w-full h-[7vh] p-[0.768vw] justify-center items-center flex-shrink-1 border-t-1.5 border-b-1.5  border-black bg-custom overflow-hidden">
