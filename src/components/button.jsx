...
const Button=({children})=>{
    ...
    return (
        ...
        <button className="custom:hidden inline-flex h-sm sm:h-[7vh] bg-button rounded-[1vh] items-center justify-center py-[1vh] px-[1vw] font-about font-normal leading text-xl sm:text-2xl md:text-5xl mt-6 md:mt-12 sm:mt-10 border-2 border-about">{children}</button>
        </>
